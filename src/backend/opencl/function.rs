...
impl OpenCLFunction {
    fn allocate(&mut self) {
        ...
        if new_size > 1024 * 1024 {
            println!("Allocating {:.2} MB of memory.", new_size as f64 / (1024.0 * 1024.0));
        } else if new_size > 1024 {
            println!("Allocating {:.2} KB of memory.", new_size as f64 / 1024.0);
        } else {
            println!("Allocating {:.2} B of memory.", new_size);
        }
