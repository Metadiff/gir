...
//#[derive(Debug, Clone)]
//pub struct TensorShapeAdd {}
//
//impl Operator for TensorShapeAdd {
//    #[allow(unused_variables, unused_mut)]
//    fn reverse_diff(&self, g: &GraphData, x: usize, dx: usize, flow_tree: &Vec<bool>)
//                    -> Result<Vec<(usize, usize)>> {
//        unimplemented!()
//    }
//
...
//    }
//
//    fn apply(&self, g: &GraphData, args: Vec<usize>) -> Result<ExprData> {
//        let args = self.verify_args(g, args)?;
//        Ok(ExprData{
//            id: 0,
//            name: "".into(),
